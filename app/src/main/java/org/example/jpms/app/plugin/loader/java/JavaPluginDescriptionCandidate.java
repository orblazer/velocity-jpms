...
class JavaPluginDescriptionCandidate extends PluginDescriptionImpl {
    private final Module module;
    private final Class<?> mainClass;

    JavaPluginDescriptionCandidate(String id, @Nullable String name, @Nullable String version,
